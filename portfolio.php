                    ...
                    <div class="isotope-item col-md-6 mb-5 mobileapp frontend">
                        <div class="card project-card">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-8">
                                    <div class="card-body">
                                        <h5 class="card-title"><a href="" class="theme-link">ISBN.is</a></h5>
                                        <p class="card-text">An elegant way to create and share beautiful and clean URLs for books.</p>
                                        <p class="card-text"><small class="text-muted">Own project</small></p>
                                    </div>
                                </div>
                            </div>
                            <!--//link-mask-->
